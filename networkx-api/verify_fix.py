...
"""
        ...
        n0 = (
            ...
            .filter(
                models.Node.network_id == final_network_id, models.Node.node_id == "n0"
            )
            .first()
        )
        ...
        n1 = (
            db.query(models.Node)
            .filter(
                models.Node.network_id == final_network_id, models.Node.node_id == "n1"
            )
            .first()
        )
        n1_desc_val = (
        ...
        node = (
            db.query(models.Node)
            .filter(
                models.Node.network_id == final_network_id,
        ...
        # Simulate logic
        details = {"id": node.node_id, "attributes": {}}
        text_attrs = (
            db.query(
