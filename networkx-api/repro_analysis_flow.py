...
def test_workflow():
    ...
    try:
        ...
        sub_node_count = db.query(models.Node).filter(models.Node.network_id == sub_id).count()
        ...
        vb = VisualizationBuilder(
            network_id=sub_id,
            db=db,
            node_size_config={"attribute": "degree_centrality", "scale_type": "LINEAR", "min_size": 5, "max_size": 20},
