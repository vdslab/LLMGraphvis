...
def export_network_to_graphml(network_id: int, db: Session) -> str:
    ...
    node_attr_defs = db.query(models.NodeAttribute).filter(models.NodeAttribute.network_id == network_id).all()
    ...
    if node_attr_defs:
        ...
        # Float Values
        float_values = db.query(models.NodeAttributeValue.node_id, models.NodeAttributeValue.attribute_id, models.NodeFloatAttributeValue.float_value)\
            .join(models.NodeFloatAttributeValue)\
            .filter(models.NodeAttributeValue.attribute_id.in_(attr_ids)).all()
        ...
        # Text Values
        text_values = db.query(models.NodeAttributeValue.node_id, models.NodeAttributeValue.attribute_id, models.NodeTextAttributeValue.text_value)\
    ...
    edge_db_id_map = {e.id: (node_db_id_map[e.source_node_id], node_db_id_map[e.target_node_id]) for e in edges if e.source_node_id in node_db_id_map and e.target_node_id in node_db_id_map}
    ...
    # Edge Attributes
    edge_attr_defs = db.query(models.EdgeAttribute).filter(models.EdgeAttribute.network_id == network_id).all()
    ...
    if edge_attr_defs:
        ...
        # Float Values
        float_values = db.query(models.EdgeAttributeValue.edge_id, models.EdgeAttributeValue.attribute_id, models.EdgeFloatAttributeValue.float_value)\
            .join(models.EdgeFloatAttributeValue)\
            .filter(models.EdgeAttributeValue.attribute_id.in_(attr_ids)).all()
        ...
        # Text Values
        text_values = db.query(models.EdgeAttributeValue.edge_id, models.EdgeAttributeValue.attribute_id, models.EdgeTextAttributeValue.text_value)\
