...
async def create_ego_network(
    ...
    result = await mcp_client.execute_tool("create_ego_network", {
...
async def create_subgraph_from_nodes(
    ...
    result = await mcp_client.execute_tool("create_subgraph_from_nodes", {
        "source_network_id": network_id, 
...
async def create_path_subgraph(
    ...
    result = await mcp_client.execute_tool("create_path_subgraph", {
        "source_network_id": network_id, 
...
async def create_k_core_subgraph(
    ...
    result = await mcp_client.execute_tool("create_k_core_subgraph", {
        "source_network_id": network_id, 
        "k": request.k
    })
    return result
...
async def create_largest_component_subgraph(
    ...
    result = await mcp_client.execute_tool("create_largest_component_subgraph", {
        "source_network_id": network_id
    })
    return result
...
async def create_component_containing_node(
    ...
    result = await mcp_client.execute_tool("create_component_containing_node", {
        "source_network_id": network_id, 
...
async def get_top_nodes(
    ...
    result = await mcp_client.execute_tool("get_top_nodes", {
...
async def get_node_details(
    ...
    result = await mcp_client.execute_tool("read_node_details", {
        "network_id": network_id, 
        "node_id": node_id
    })
