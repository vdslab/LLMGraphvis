    ...
    example_1 = [
            ...
            parts=[
                types.Part(
                    function_call=types.FunctionCall(
                        name="list_node_attributes", args={}
                    )
                )
            ],
        ),
            ...
            parts=[
                types.Part(
                    function_response=types.FunctionResponse(
                        name="list_node_attributes", response={"attributes": ["weight"]}
                    )
                )
            ],
        ),
        types.Content(
            ...
            parts=[
                types.Part(
                    function_call=types.FunctionCall(
                        name="calculate_centrality", args={"centrality_type": "degree"}
                    )
                )
            ],
        ),
            ...
            parts=[
                types.Part(
                    function_response=types.FunctionResponse(
                        ...
                        response={
                            "status": "success",
                            "message": "Calculated degree centrality.",
                        },
                    )
                )
            ],
            ...
            parts=[
                types.Part(
                    function_response=types.FunctionResponse(
                        ...
                        response={"attributes": ["weight", "degree_centrality"]},
                    )
                )
            ],
        ),
